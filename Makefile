#############################################################################
# Makefile for building: 3DTest
# Generated by qmake (3.0) (Qt 5.6.2)
# Project:  3DTest.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile 3DTest.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = 3DTest1.0.0
DISTDIR = /storage/home/otterbeck/Train/3DTest/.tmp/3DTest1.0.0
LINK          = g++
LFLAGS        = 
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		3DTest.pro mainwindow.h main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = 3DTest
DESTDIR       = 
TARGET        = 3DTest
...
Makefile: 3DTest.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug -o Makefile 3DTest.pro
...
moc_mainwindow.cpp: mainwindow.h \
		moc_predefs.h
	/usr/lib64/qt5/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/storage/home/otterbeck/Train/3DTest -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/4.8.5 -I/usr/include/c++/4.8.5/x86_64-redhat-linux -I/usr/include/c++/4.8.5/backward -I/usr/lib/gcc/x86_64-redhat-linux/4.8.5/include -I/usr/local/include -I/usr/include mainwindow.h -o moc_mainwindow.cpp
